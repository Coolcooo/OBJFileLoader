    ...
    def __init__(self, filename, swapyz=False):
        ...
        for line in open(filename, "r"):
            ...
            if values[0] == 'v':
                ...
                if swapyz:
                    v = v[0], v[2], v[1]
                if len(self.list_max) == 0:
                    self.list_max.extend(v)
                    self.list_min.extend(v)
                else:
                    if v[0] > self.list_max[0]:
                        self.list_max[0] = v[0]
                    if v[1] > self.list_max[1]:
                        self.list_max[1] = v[1]
                    if v[2] > self.list_max[2]:
                        self.list_max[2] = v[2]
                    if v[0] < self.list_min[0]:
                        self.list_min[0] = v[0]
                    if v[1] < self.list_min[1]:
                        self.list_min[1] = v[1]
                    if v[2] < self.list_min[2]:
                        self.list_min[2] = v[2]
